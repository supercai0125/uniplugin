...
public class IntentWrapper {
    ...
    public static List<IntentWrapper> getIntentWrapperList(Context context) {
        ...
        /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            boolean ignoringBatteryOptimizations = pm.isIgnoringBatteryOptimizations(getPackageName(context));
            if (!ignoringBatteryOptimizations) {
                Intent dozeIntent = new Intent(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS);
                dozeIntent.setData(Uri.parse("package:" + getPackageName(context)));
        ...
        xiaomiGodIntent.putExtra("package_name", getPackageName(context));
        ...
        meizuIntent.putExtra("packageName", getPackageName(context));
        ...
        //Oppo 自启动管理
        Intent oppoIntent = context.getPackageManager().getLaunchIntentForPackage("com.coloros.phonemanager");
        sIntentWrapperList.add(new IntentWrapper(oppoIntent, OPPO));

        //Oppo 自启动管理(旧版本系统)
        Intent oppoOldIntent = new Intent();
        oppoOldIntent.setComponent(new ComponentName("com.coloros.phonemanager", "com.color.safecenter.permission.startup.StartupAppListActivity"));
     ...
     */
    public static List<IntentWrapper> whiteListMatters(String reason, Context context) {
                        ...
                        new AlertDialog.Builder(context)
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface d, int w) {
                                        iw.startActivitySafely(context);
                                    }
                                })
                                .show();
                        showed.add(iw);
     ...
     * 安全地启动一个Activity
     */
    protected void startActivitySafely(Context context) {
        try {
