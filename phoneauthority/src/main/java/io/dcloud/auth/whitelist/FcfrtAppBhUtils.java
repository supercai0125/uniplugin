package io.dcloud.auth.whitelist;
...
public class FcfrtAppBhUtils {
     ...
     * @param context
     */
    public static void goXiaomiGod(Context context) {
        ...
        xiaomiGodIntent.putExtra("package_label", getAppName(context));
        context.startActivity(xiaomiGodIntent);
    }
